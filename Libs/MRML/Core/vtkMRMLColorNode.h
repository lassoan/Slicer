...
public:
  ...
  /// The method is deprecated and has no effect anymore, as now there is a
  /// "defined" flag for each color table entry.
  vtkGetMacro(NamesInitialisedX, int);
  vtkSetMacro(NamesInitialisedX, int);
  vtkBooleanMacro(NamesInitialisedX, int);
  ///
