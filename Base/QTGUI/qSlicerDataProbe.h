...
#ifndef __qSlicerDataProbe_h
#define __qSlicerDataProbe_h
...
class qSlicerDataProbePrivate;

class Q_SLICER_BASE_QTGUI_EXPORT qSlicerDataProbe
...
public:
  ...
  qSlicerDataProbe(QWidget* parent = nullptr, Qt::WindowFlags f = nullptr);
  ~qSlicerDataProbe() override;
...
protected:
  QScopedPointer<qSlicerDataProbePrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qSlicerDataProbe);
  Q_DISABLE_COPY(qSlicerDataProbe);
};
