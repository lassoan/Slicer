...
//
vtkMRMLSliceLogic *setupSliceDisplay2(vtkMRMLScene *scene, vtkRenderWindow *rw, const char *archetype)
{
...
int qSlicerDataProbeTest1(int argc, char * argv[] )
{
  if (argc != 2 && argc != 3)
    {
...
#if VTK_MAJOR_VERSION >= 9 || (VTK_MAJOR_VERSION >= 8 && VTK_MINOR_VERSION >= 90)
  vtkMRMLSliceLogic* sliceLogic = setupSliceDisplay2(
