...
void qMRMLSegmentationShow3DButtonPrivate::init()
{
  ...
  this->SurfaceNetsEnableAction->setToolTip(
    qMRMLSegmentationShow3DButton::tr("Create closed surface using 'surface nets' method (default). Uncheck to use slower
'flying edges' method, which was the default in earlier software versions."));
