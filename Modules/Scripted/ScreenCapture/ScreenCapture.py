...
class ScreenCaptureLogic(ScriptedLoadableModuleLogic):
  ...
  def getFfmpegPath(self):
    ...
    if settings.contains('General/ffmpegPath'):
      return slicer.app.toSlicerHomeAbsolutePaths(settings.value('General/ffmpegPath'))
    return ''
  ...
  def setFfmpegPath(self, ffmpegPath):
    ...
    settings = qt.QSettings()
    if settings.contains('General/ffmpegPath'):
      if ffmpegPath == slicer.app.toSlicerHomeAbsolutePaths(settings.value('General/ffmpegPath')):
        return
    settings.setValue('General/ffmpegPath', slicer.app.toSlicerHomeRelativePaths(ffmpegPath))
